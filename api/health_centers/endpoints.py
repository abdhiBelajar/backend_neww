...
@health_centers_bp.route('/<int:kode_faskes>', methods=['GET'])
...
@health_centers_bp.route('/<int:kode_faskes>', methods=['PUT'])
...
@health_centers_bp.route('/<int:kode_faskes>', methods=['DELETE'])
